...
A: In the units, the diagonal lines will be represented by two additional units. Boxes on the diagonal will have four units instead of three.  The number of peers they have increases as a function of this addition, but the other parts of the algorithm will work as usual.
